...
namespace str{
	...
	template int read_charclass<const char32_t*,bool (&)(char),u32string>(const char32_t* * pit, bool (&)(char), u32string * pstr);
	template int read_charclass<char*,string>(char* * pit, span<typename iterator_traits<char*>::value_type> s, string * pstr);
	template int read_charclass<wchar_t*,wstring>(wchar_t* * pit, bispan<typename iterator_traits<wchar_t*>::value_type> s, wstring * pstr);
	...
	template int read_s_charclass<wchar_t*,bool(&)(wchar_t),wstring>(wchar_t* * pit, bool(&)(wchar_t), wstring * ps);
	...
	template int read_b_charclass<const char*,bool(&)(char),string>(const char* * pit, bool(&)(char), string * ps);
